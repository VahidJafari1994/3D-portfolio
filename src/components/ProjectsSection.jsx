...
const ProjectsSection = () => {
  ...
  useEffect(() => {
    ...
    const horizintalScroll = gsap.to('.panel', {
    ...
    panels.forEach((panel, i) => {
      ...
      const tl = gsap.timeline({
        scrollTrigger: {
          trigger: panel,
          containerAnimation: horizintalScroll,
          start: 'left right',
          end: 'right left',
          scrub: 1,
        },
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 mb-16 relative z-10">
        <h2
          ref={titleRef}
          className="tet-4xl md:text-5xl lg:text-6xl font-bold text-black text-center mb-4 opacity-0"
        >
          Featured Projects
        </h2>
        <div
      ...
      <div ref={triggerRef} className="oveflow-hidden opacity-0">
        <div
          ref={horizontalRef}
