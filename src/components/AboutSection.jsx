...
const AboutSection = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="h-screen realtive overflow-hidden bg-gradient-to-b from-black to-[#9a74cf50]"
    >
      ...
      <div className="container mx-auto px-4 h-full flex flex-col items-center justify-center">
        <h1
          ref={titleRef}
          className="text-4xl md:text-6xl font-bold sm:mb-16 text-center text-white opacity-0 md:mt-6"
        >
          About Me
        </h1>
      </div>
      ...
      >
        <h3 className="text-sm md:text-2xl font-bold text-purple-200 z-50 lg:max-w-[45rem] max-w-[27rem] tracking-wider md:mt-20 sm:mt-[-40rem] mt-[-32rem]">
          Hi, I'm Vahid, a Frontend Developer focused on speed, polish and
